...
export default class GlobalFooter extends React.Component<IGlobalFooterApplicationCustomizerProperties
  & { navItems: IMSNavItem[], pageNavs: IPageNavs }> {
          ...
          <div className={styles.globalFooterNavigation + ' ms-Grid-row'}>
            <div className='ms-Grid-col ms-sm6 ms-lg6' >
                ...
                <a href={this.props.pageNavs.previous}>
                  <IconButton  iconProps={{ iconName: 'Back' }} ></IconButton>{" " + this.props.pageNavs.previousTitle}</a> : <span></span>}
            ...
            <div className='ms-Grid-col ms-sm6 ms-lg6' >
                ...
                <a href={this.props.pageNavs.next}>
                  {this.props.pageNavs.nextTitle + " "}<IconButton  iconProps={{ iconName: 'Forward' }} ></IconButton></a> : <span></span>}
          ...
          <div className={styles.globalFooterbar + ' ms-Grid-row'}>
            <div className='ms-Grid-col ms-sm12 ms-lg3' >
              <span className={styles.footerTitle}>
                <a href='https://mybcecatholicedu.sharepoint.com/SitePages/Home.aspx'>Brisbane Catholic Education</a>
              </span>
            </div>
            <div className='ms-Grid-col ms-sm12 ms-lg9' >
              <span>
                <a href='https://mybcecatholicedu.sharepoint.com/'>Copyright</a>&nbsp;|&nbsp;
                      <a href='https://mybcecatholicedu.sharepoint.com/'>Privacy policy</a>&nbsp;|&nbsp;
                      <a href='http://www.bne.catholic.edu.au/aboutus/'>Terms of use</a>&nbsp;|&nbsp;
                      <a href='http://www.bne.catholic.edu.au/aboutus/'>Contact</a>&nbsp;|&nbsp;
                      <a href='http://www.bne.catholic.edu.au/aboutus/Pages/Acknowledgement-of-country.aspx'>Acknowledgement of country</a>
              </span>
            </div>
          </div>
        </div>
